### The new c3d to numpy struct / vectorized functions API is found in the [struct_vec_api](https://github.com/MattGonz/PyCGM_Prototypes/tree/main/struct_vec_api/) folder
